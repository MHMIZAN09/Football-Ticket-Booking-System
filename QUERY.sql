...
CREATE TABLE Users (
    ...
    role VARCHAR(100) NOT NULL CHECK (role IN ('Football Fan', 'Ticket Manager')),
...
CREATE TABLE Bookings (
    ...
    match_id INT NOT NULL REFERENCES Matches(match_id) ON DELETE CASCADE ON UPDATE CASCADE,
